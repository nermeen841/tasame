...
import 'package:zat/presentation/screens/qustionare/widget/questions_view_body.dart';
import '../../../../generator/localization_constant.dart';
import '../../../widget/internalscreen_appbar.dart';
import '../../splash/splash.dart';

class QustionsView extends StatefulWidget {
  final int quastionareId;
  const QustionsView({Key? key, required this.quastionareId}) : super(key: key);

  @override
  State<QustionsView> createState() => _QustionsViewState();
}

class _QustionsViewState extends State<QustionsView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: QuestionViewBody(
        quastionareId: widget.quastionareId,
      ),
    );
  }
}
