...
import 'package:zat/presentation/screens/blogs%20screens/widget/write_blog_body.dart';
...
class WriteYourBlogScreen extends StatefulWidget {
  const WriteYourBlogScreen({Key? key}) : super(key: key);

  @override
  State<WriteYourBlogScreen> createState() => _WriteYourBlogScreenState();
}

class _WriteYourBlogScreenState extends State<WriteYourBlogScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
          onRefresh: () => GetIt.I<BlogsCubit>().getWrittingdata(),
          child: const WriteYourBlogBody()),
    );
  }
}
