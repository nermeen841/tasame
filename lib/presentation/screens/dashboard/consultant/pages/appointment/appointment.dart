...
class ManageTutorAppointmentScreen extends StatefulWidget {
  final bool? fromHome;
  const ManageTutorAppointmentScreen({Key? key, this.fromHome})
      : super(key: key);

  @override
  State<ManageTutorAppointmentScreen> createState() =>
      _ManageTutorAppointmentScreenState();
}

class _ManageTutorAppointmentScreenState
    extends State<ManageTutorAppointmentScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: (widget.fromHome == true)
          ...
          : null,
      body: const ManageAppointmentBody(),
    );
  }
}
